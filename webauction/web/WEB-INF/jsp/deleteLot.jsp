...
<body>
    ...
    <div class="register-container">
        <form method="post" action = "controller" class="register" id="register">
            <input type="hidden" name="command" value="del_lot">
            ...
            <p>
                <input type="button" id="refreshAuc" class="add-email-button" onclick="refreshAuctionsForDeleteLos()" value="Refresh">
            </p>


            <p class="register-submit">
                <button type="submit" class="register-button">${deletelot}</button>
            </p>
        </form>
    </div>
